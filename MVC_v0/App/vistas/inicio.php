    ...
    <div class="container-fluid d-flex flex-column flex-lg-row justify-content-center align-items-center h-100 w-100">
            ...
            <div class="col-lg-8 d-none d-lg-block d-flex justify-content-center">
                <div class="d-flex justify-content-center">
                    <p class="fs-3 fw-bold text-center w-75">Te damos la bienvenida al Catálogo Digital de la
                        Comarca del Bajo Aragón, un espacio en el que
                        podrás publicitar y consultar negocios que se
                        traspasan y locales y viviendas en alquiler, así
                        como explorar los servicios que existen en cada

                        una de nuestros pueblos.

                        La Comarca del Bajo Aragón tiene mucho que
            ...
            <div class="col-12 d-lg-none d-block d-flex justify-content-center">
                <div class="d-flex align-items-center">
                    ...
                    <p class="fs-3 fw-bold text-center w-100 pe-3 ps-3 ms-3 me-3 pb-3">

                        La Comarca del Bajo Aragón tiene mucho que

                        ofrecer<br> ¡DESCRÚBELO!
                    </p>
                </div>
            </div>
